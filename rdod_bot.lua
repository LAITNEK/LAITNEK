 BOT_NAME = redis:get(LAITNEK..'bot:name')
do 
...
redis:setex(LAITNEK..'namebot:witting'..msg.from.id,300,true)
...
return send_inline_key(msg.from.id,text,keyboard)
 ...
 redis:sadd(LAITNEK..'users',msg.from.id)
...
if (msg.to.type == "pv") and not we_sudo(msg) and not redis:get(LAITNEK..'lock_twasel') and msg.from.id ~= our_id then -- ارسال رساله للاعضاء الي يدخلون خاص
...
local group = redis:smembers(LAITNEK..'group:ids')
local pv = redis:smembers(LAITNEK..'users')
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..#group..'\n👤*¦* عدد المشتركين في البوت : '..#pv..'\n📡'
end
---------------[End Function data] -----------------------
if r=="اضف رد عام" or r=="اضف رد عام ➕" then
if not we_sudo(msg) then return "☔️هذا الاوامر للمطور الاساسي فقط 🌑" end
redis:setex(LAITNEK..'addrd_all:'..msg.to.id..msg.from.id,300 , true)
redis:del(LAITNEK..'allreplay:'..msg.to.id..msg.from.id)
...
if redis:get(LAITNEK..'namebot:witting'..msg.from.id) then --- استقبال اسم البوت 
redis:del(LAITNEK..'namebot:witting'..msg.from.id)
redis:set(LAITNEK..'bot:name',msg.text)
reload_plugins() 
return "📭¦ تم تغير اسم البوت  ✋🏿\n🗯¦ الان اسمه `"..msg.text.."` \n✓"
end
if redis:get(LAITNEK..'addrd_all:'..msg.to.id..msg.from.id) then -- استقبال الرد لكل المجموعات
if not redis:get(LAITNEK..'allreplay:'..msg.to.id..msg.from.id) then-- استقبال كلمه الرد لكل المجموعات
redis:hdel(LAITNEK..'replay_photo:group:',msg.text)
redis:hdel(LAITNEK..'replay_voice:group:',msg.text)
redis:hdel(LAITNEK..'replay_animation:group:',msg.text)
redis:hdel(LAITNEK..'replay_audio:group:',msg.text)
redis:hdel(LAITNEK..'replay_sticker:group:',msg.text)
redis:hdel(LAITNEK..'replay_video:group:',msg.text)
redis:setex(LAITNEK..'allreplay:'..msg.to.id..msg.from.id,300,msg.text)
return "📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-" 
end
if redis:get(LAITNEK..'allreplay:'..msg.to.id..msg.from.id) then -- استقبال جواب الرد لكل المجموعات
redis:hset(LAITNEK..'replay:all', redis:get(LAITNEK.."allreplay:"..msg.to.id..msg.from.id),msg.text)
redis:del(LAITNEK..'addrd_all:'..msg.to.id..msg.from.id)
return '(['..redis:get(LAITNEK..'allreplay:'..msg.to.id..msg.from.id)..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 '
end end
-------------------------------------------------------------
if redis:get(LAITNEK..'addrd:'..msg.to.id..msg.from.id) then -- استقبال الرد للمجموعه فقط
if not redis:get(LAITNEK..'replay1'..msg.to.id..msg.from.id) then  -- كلمه الرد
redis:hdel(LAITNEK..'replay:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_photo:group:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_voice:group:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_animation:group:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_audio:group:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_sticker:group:'..msg.to.id,msg.text)
redis:hdel(LAITNEK..'replay_video:group:'..msg.to.id,msg.text)
redis:setex(LAITNEK..'replay1'..msg.to.id..msg.from.id,300,msg.text)
return "📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-" 
end
if redis:get(LAITNEK..'replay1'..msg.to.id..msg.from.id) then -- جواب الرد
redis:hset(LAITNEK..'replay:'..msg.to.id, redis:get(LAITNEK.."replay1"..msg.to.id..msg.from.id),msg.text)
redis:del(LAITNEK..'addrd:'..msg.to.id..msg.from.id)
return '(['..redis:get(LAITNEK..'replay1'..msg.to.id..msg.from.id)..'])\n  ✓ تم اضافت الرد 🚀 \n-'
end end
if redis:get(LAITNEK..'delrd:'..msg.from.id) then
redis:del(LAITNEK..'delrd:'..msg.from.id)
local names = redis:hget(LAITNEK..'replay:'..msg.to.id,msg.text)
local photo =redis:hget(LAITNEK..'replay_photo:group:'..msg.to.id,msg.text)
local voice = redis:hget(LAITNEK..'replay_voice:group:'..msg.to.id,msg.text)
local animation = redis:hget(LAITNEK..'replay_animation:group:'..msg.to.id,msg.text)
local audio = redis:hget(LAITNEK..'replay_audio:group:'..msg.to.id,msg.text)
local sticker = redis:hget(LAITNEK..'replay_sticker:group:'..msg.to.id,msg.text)
local video = redis:hget(LAITNEK..'replay_video:group:'..msg.to.id,msg.text)
...
if redis:get(LAITNEK..'delrdall:'..msg.from.id) then
redis:del(LAITNEK..'delrdall:'..msg.from.id)
local names = redis:hget(LAITNEK..'replay:all',msg.text)
local photo =redis:hget(LAITNEK..'replay_photo:group:',msg.text)
local voice = redis:hget(LAITNEK..'replay_voice:group:',msg.text)
local animation = redis:hget(LAITNEK..'replay_animation:group:',msg.text)
local audio = redis:hget(LAITNEK..'replay_audio:group:',msg.text)
local sticker = redis:hget(LAITNEK..'replay_sticker:group:',msg.text)
local video = redis:hget(LAITNEK..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return '💬*¦* هذا الرد ليس مضاف في قائمه الردود 📛'
else
redis:hdel(LAITNEK..'replay:all',msg.text)
redis:hdel(LAITNEK..'replay_photo:group:',msg.text)
redis:hdel(LAITNEK..'replay_voice:group:',msg.text)
redis:hdel(LAITNEK..'replay_audio:group:',msg.text)
redis:hdel(LAITNEK..'replay_animation:group:',msg.text)
...
local photo =redis:hkeys(LAITNEK..'replay_photo:group:'..msg.to.id)
local voice = redis:hkeys(LAITNEK..'replay_voice:group:'..msg.to.id)
local animation = redis:hkeys(LAITNEK..'replay_animation:group:'..msg.to.id)
local audio = redis:hkeys(LAITNEK..'replay_audio:group:'..msg.to.id)
local sticker = redis:hkeys(LAITNEK..'replay_sticker:group:'..msg.to.id)
local video = redis:hkeys(LAITNEK..'replay_video:group:'..msg.to.id)
...
for i=1, #photo do redis:hdel(LAITNEK..'replay_photo:group:'..msg.to.id,photo[i]) end
for i=1, #voice do redis:hdel(LAITNEK..'replay_voice:group:'..msg.to.id,voice[i]) end
for i=1, #animation do redis:hdel(LAITNEK..'replay_animation:group:'..msg.to.id,animation[i]) end
for i=1, #audio do redis:hdel(LAITNEK..'replay_audio:group:'..msg.to.id,audio[i]) end
for i=1, #sticker do redis:hdel(LAITNEK..'replay_sticker:group:'..msg.to.id,sticker[i]) end
for i=1, #video do redis:hdel(LAITNEK..'replay_video:group:'..msg.to.id,video[i]) end
return "✓ تم مسح كل الردود 🚀"
end
if r== 'مسح الردود العامه' then
if not is_sudo(msg) then return"♨️ للمطورين فقط ! 💯" end
local names = redis:hkeys(LAITNEK..'replay:all')
local photo =redis:hkeys(LAITNEK..'replay_photo:group:')
local voice = redis:hkeys(LAITNEK..'replay_voice:group:')
local animation = redis:hkeys(LAITNEK..'replay_animation:group:')
local audio = redis:hkeys(LAITNEK..'replay_audio:group:')
local sticker = redis:hkeys(LAITNEK..'replay_sticker:group:')
local video = redis:hkeys(LAITNEK..'replay_video:group:')
for i=1, #names do redis:hdel(LAITNEK..'replay:all',names[i]) end
for i=1, #photo do redis:hdel(LAITNEK..'replay_photo:group:',photo[i]) end
for i=1, #voice do redis:hdel(LAITNEK..'replay_voice:group:',voice[i]) end
for i=1, #animation do redis:hdel(LAITNEK..'replay_animation:group:',animation[i]) end
for i=1, #audio do redis:hdel(LAITNEK..'replay_audio:group:',audio[i]) end
for i=1, #sticker do redis:hdel(LAITNEK..'replay_sticker:group:',sticker[i]) end
for i=1, #video do redis:hdel(LAITNEK..'replay_video:group:',video[i]) end
return "✓ تم مسح كل الردود العامه🚀"
end
if r== 'مسح رد عام' then
if not is_sudo(msg) then return"♨️ للمطورين فقط ! 💯" end
redis:set(LAITNEK..'delrdall:'..msg.from.id,true) return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end
if r== 'مسح رد' then
if not is_owner(msg) then return"♨️ للمدراء فقط ! 💯" end redis:set(LAITNEK..'delrd:'..msg.from.id,true)
...
if not redis:get(LAITNEK..'group:add'..msg.to.id) then return end
if r=="اضف رد" then
if not is_owner(msg) then return"♨️ للمدراء فقط ! 💯" end
redis:setex(LAITNEK..'addrd:'..msg.to.id..msg.from.id,300,true) redis:del(LAITNEK..'replay1'..msg.to.id..msg.from.id)
...
if msg.text and redis:get(LAITNEK..'replay'..msg.to.id) and msg.to.type == "channel" then
-- by @LAITNEK
...
if redis:get(LAITNEK..":msg_id"..msg.to.id) then
if msg.reply_id then  msgx_id = msg.reply_id  else msgx_id = false end else msgx_id = msg.id_  end
if msgx_id then
if redis:hget(LAITNEK..'replay:all',r) then return sendMsg(msg.to.id,msgx_id,"["..redis:hget(LAITNEK..'replay:all',r).."]",'md')
elseif redis:hget(LAITNEK..'replay_photo:group:',r) then return sendPhoto(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_photo:group:',r))  
elseif redis:hget(LAITNEK..'replay_voice:group:',r) then return sendVoice(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_voice:group:',r))
elseif redis:hget(LAITNEK..'replay_animation:group:',r) then return sendAnimation(msg.to.id,msgx_id,0,1, nil,redis:hget(LAITNEK..'replay_animation:group:',r))  
elseif redis:hget(LAITNEK..'replay_audio:group:',r) then return sendAudio(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_audio:group:',r))  
elseif redis:hget(LAITNEK..'replay_sticker:group:',r) then return sendSticker(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_sticker:group:',r))  
elseif redis:hget(LAITNEK..'replay_video:group:',r) then return sendVideo(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_video:group:',r))
--==============================
elseif redis:hget(LAITNEK..'replay_photo:group:'..msg.to.id,r) then return sendPhoto(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_photo:group:'..msg.to.id, r))  
elseif redis:hget(LAITNEK..'replay_voice:group:'..msg.to.id,r) then return sendVoice(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_voice:group:'..msg.to.id, r))
elseif redis:hget(LAITNEK..'replay_animation:group:'..msg.to.id,r) then return sendAnimation(msg.to.id,msgx_id,0,1, nil,redis:hget(LAITNEK..'replay_animation:group:'..msg.to.id, r))  
elseif redis:hget(LAITNEK..'replay_audio:group:'..msg.to.id,r) then return sendAudio(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_audio:group:'..msg.to.id, r))  
elseif redis:hget(LAITNEK..'replay_sticker:group:'..msg.to.id,r) then return sendSticker(msg.to.id,msgx_id,0,1,nil,redis:hget(LAITNEK..'replay_sticker:group:'..msg.to.id, r))  
elseif redis:hget(LAITNEK..'replay_video:group:'..msg.to.id,r) then return sendVideo(msg.to.id,msgx_id,0,1,nil, redis:hget(LAITNEK..'replay_video:group:'..msg.to.id, r))
elseif redis:hget(LAITNEK..'replay:'..msg.to.id,r) then return sendMsg(msg.to.id,msgx_id,"["..redis:hget(LAITNEK..'replay:'..msg.to.id, r).."]",'md') 
end else
if redis:hget(LAITNEK..'replay:all',r) or redis:hget(LAITNEK..'replay_photo:group:'..msg.to.id,r) or redis:hget(LAITNEK..'replay_voice:group:'..msg.to.id,r) or redis:hget(LAITNEK..'replay_animation:group:'..msg.to.id,r) or redis:hget(LAITNEK..'replay_audio:group:'..msg.to.id,r) or  redis:hget(LAITNEK..'replay_sticker:group:'..msg.to.id,r) or redis:hget(LAITNEK..'replay_video:group:'..msg.to.id,r) or redis:hget(LAITNEK..'replay:'..msg.to.id,r) then
