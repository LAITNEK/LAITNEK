...
local update = redis:get(LAITNEK..":VERSION")
...
redis:srem(LAITNEK..':PLUGINS_FILE:',matches[2])
...
download_file(file_plug,'./plugins/'..matches[2]..".lua") redis:sadd(LAITNEK..':PLUGINS_FILE:',matches[2]) reload_plugins() else
...
if not we_sudo(msg)  then return "📛*￤* هذا الاوامر للمطور الاساسي فقط 🛠" end
local num_update = https.request('https://api.th3LAITNEK.com/version/') -- تحقق من التحديث اذا كان موجود او لا
if num_update > update then
sendMsg(msg.to.id,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...','md')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/inc/BOT.lua','./inc/BOT.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/inc/locks.lua','./inc/locks.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/plugins/cmd_help.lua','./plugins/cmd_help.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/plugins/plug_manager.lua','./plugins/plug_manager.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/plugins/proc_msgs.lua','./plugins/proc_msgs.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/plugins/rdod_bot.lua','./plugins/rdod_bot.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LAITNEK/master/plugins/super_group.lua','./plugins/super_group.lua')
redis:set(LAITNEK..":VERSION",num_update)
sendMsg(msg.to.id,msg.id_,'🔝*┇* تم تحديث السورس الى اصدار *v'..redis:get(LAITNEK..":VERSION")..'*\n📟*┇* سوف يتم اعاده تشغيل السورس انتظر ثواني ...','md')
sleep(1)
RELOAD_BOT(msg)
else
...
end sendMsg(msg.to.id,msg.id_,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..#redis:smembers(LAITNEK..'group:ids')..'* 🌿\n✓','md')
